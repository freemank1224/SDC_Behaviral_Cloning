...
#                augmented_angles.append(augmented_angles)
#                augmented_images.append(cv2.flip(image, 1))
#                augmented_angles.append(augmented_angles * -1)
#                
...
#train_gen = next(generator(train_samples, batch_size = 32))
#valid_gen = next(generator(valid_samples, batch_size = 32))
...
obj = model.fit(samples, labels, validation_split=0.2, shuffle=True, nb_epoch=5)
